...
<head>
    ...
    <title>Login - Kopi KPR</title>
    <style>
        /* ==========================================
           1. LATAR BELAKANG (BACKGROUND EXPERIENCE)
           ========================================== */
        body { 
        ...
        /* ==========================================
           2. AREA BRANDING LOGO DI ATAS CARD
           ========================================== */
        .brand-container {
            text-align: center;
            margin-bottom: 30px;
        ...
        /* ==========================================
           3. KOTAK UTAMA (SUPER BESAR & PANJANG KE BAWAH)
           ========================================== */
        .card { 
            background: #3e2a1a; 
            padding: 60px 60px 50px 60px; /* Ruang dalam dibuat sangat longgar */
            border-radius: 28px; 
            box-shadow: 0 25px 55px rgba(0, 0, 0, 0.45), 0 0 0 1px rgba(213, 189, 175, 0.15); 
            width: 520px;        /* Jauh lebih lebar dan gagah */
            min-height: 780px;   /* KUNCI: Sangat panjang ke bawah sesuai request */
            box-sizing: border-box;
        ...
        /* ==========================================
           4. BAGIAN ATAS: JUDUL (NAIK TINGGI KE ATAS)
           ========================================== */
        h2 { 
            margin-top: 0; 
            color: #f6f3ed; 
        ...
        /* Menghilangkan garis hijau secara total */
        h2::after {
            display: none !important; 
        }

        /* ==========================================
           5. BAGIAN TENGAH: FORM INPUT & TOMBOL
           ========================================== */
        form {
            margin-top: auto;    /* Mengunci seluruh form tepat di tengah vertikal card */
        ...
        .group { 
            margin-bottom: 35px; /* Jarak antar kolom input dibuat sangat lega */
        }
        ...
        .group input { 
            width: 100%; 
            padding: 20px 22px; /* Kolom input lebih tebal */
            box-sizing: border-box; 
        ...
        button { 
            width: 100%; 
            padding: 20px; /* Ukuran tombol disesuaikan menjadi besar */
            background: #406346; 
            color: #f6f3ed; 
            border: none; 
            cursor: pointer; 
        ...
        /* ==========================================
           6. BAGIAN BAWAH: TEKS REGISTER (MENTOK DI BAWAH)
           ========================================== */
        p { 
            text-align: center; 
            font-size: 15px; 
            margin-top: 0; 
            margin-bottom: 10px; /* Berada di posisi paling bawah ujung kotak */
        ...
        p a { 
            ...
            border-bottom: none !important;   /* Menghilangkan sisa garis dekorasi */
            padding-bottom: 3px;
